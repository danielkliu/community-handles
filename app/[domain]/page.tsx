        ...
        >
          ...
          <p className="mt-6 max-w-lg text-sm">
            ...
            <a href="https://github.com/sponsors/mozzius" className="underline">
              sponsoring thedeveloper&apos;s work.</a> This custom domain project and hosting is community-run, click <a href="https://ko-fi.com/lorcanafanatics">here</a> to support it.
            .
          </p>
        </Stage>
      </div>
